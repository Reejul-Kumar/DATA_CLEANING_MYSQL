...
**OVERVIEW**<br>
This project focuses on cleaning sales data using MySQL. Duplicate transactions are removed, missing values are filled with suitable replacements, and errors like negative quantities are fixed. Null values in columns such as price and category are replaced with averages or placeholder text to keep the data complete. Columns with missing customer address or payment method information are updated to say "Not Available" or "Cash." Email formats and data types are checked to make sure all information is consistent. These steps help create a reliable dataset for analysis and reporting.

<br>

**FEATURES** <br>
- Removing duplicate records to ensure each transaction is unique.
- Checking for and handling missing (null) values by replacing them with averages or placeholder text
- Correcting negative values in numeric columns by converting them to absolute values.
- Standardizing inconsistent data entries, such as different forms of payment method names.
- Validating email addresses to identify incorrect formats
- Ensuring all columns have the correct data types for consistenc
...
<br>
To select all rows from sales table <br>
...
<br> first of all , I find out duplicate rows
...
- Step 4 :- Handling Negative values <br>
...
```
- Step 5 :- Check email address and date <br>
